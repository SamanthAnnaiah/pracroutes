        ...
        <div className="p-2">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="ml-4 text-gray-600">5,000 Links/month</span>
            </div>
            <div className="flex items-center">
              <svg
                className="w-5 h-5 text-[hsl(180,66%,49%)]"
              ...
              <span className="ml-4 text-gray-600">Basic Analytics</span>
            </div>
            <div className="flex items-center">
              <svg
                className="w-5 h-5 text-[hsl(180,66%,49%)]"
              ...
              <span className="ml-4 text-gray-600">Branded Links</span>
            </div>
          </div>
        </div>
